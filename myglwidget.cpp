...
void MyGLWidget::initializeGL()
{
    ...
    f->glShadeModel(GL_SMOOTH);//GL_SMOOTH


    GLfloat light0_position[] = { 0.0, 2, 0, 1.0 };
    f->glLightfv(GL_LIGHT0, GL_POSITION, light0_position);
    GLfloat light0_diffuse[] = {1, 1, 1};
    f->glLightfv(GL_LIGHT0, GL_DIFFUSE, light0_diffuse);

    GLfloat ambience[] = {1.0f, 1.0f, 1.0f, 0.0};
    f->glLightfv(GL_LIGHT0, GL_AMBIENT,  ambience);
    GLfloat  light0_specular[] = { 1, 1, 1, 1} ;
    f->glLightfv ( GL_LIGHT0, GL_SPECULAR, light0_specular );
